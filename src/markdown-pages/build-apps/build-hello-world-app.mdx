...
description: 'Build a "Hello, World!" app and publish it to Simplify One'
redirects:
...
Here's how you can quickly build a "Hello, World!" application in Simplify One. In these steps, you create a local version of the Simplify One site where you can prototype your application. Then, when you're ready to share the application with others, you can publish it to Simplify One.
...
To get started, make sure you have accounts in GitHub and [Simplify](https://newrelic.com/signup/).

To develop projects, you need the Simplify One CLI (command line interface).
...
The CLI allows you to run a local version of Simplify One. You can develop your application locally before you publish it in Simplify One.
...
## Publish your application to Simplify

Your colleagues can't see your local application, so when you are ready to share it, publish it to the Simplify One catalog. The catalog is where you can find any pre-existing custom applications, as well as any applications you create in your own organization.
...
Close your local Simplify One development tab, and open [Simplify One](https://one.newrelic.com).
...
Under **Simplify One catalog**, click the launcher for your new application.
...
Now that your new application is in the Simplify One catalog, you can add details that help users understand what your application does and how to use it.
...
- Publish the application to the Simplify One catalog so you can share it with your colleagues.
