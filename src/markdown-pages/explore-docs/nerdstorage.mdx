...
description: 'Intro to NerdStorage on Simplify One'
tileShorthand:
  title: 'Intro to NerdStorage'
...
To help you build a [Simplify One application](/use-cases/build-new-relic-one-applications), we provide you with the [Simplify One SDK](/client-side-sdk/index.html). On this page, you’ll learn how to use NerdStorage SDK components.
