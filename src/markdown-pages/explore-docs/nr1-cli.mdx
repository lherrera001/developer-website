...
title: 'Simplify One CLI reference'
template: 'GuideTemplate'
description: 'An overview of the CLI to help you build, deploy, and manage Simplify apps.'
tileShorthand:
  title: 'Simplify One CLI reference'
...
To build a [Simplify One app](/build-apps/build-hello-world-app), you must install the Simplify One CLI. The CLI helps you build, publish, and manage your Simplify app.

<br />

</Intro>

We provide a variety of tools for building apps, including the Simplify One CLI (command line interface). This page explains how to use [CLI commands](#new-relic-one-cli-commands) to:
...
## Installing the Simplify One CLI

In Simplify, click **Apps** and then in the **Simplify One catalog** area, click the [**Build your own application** launcher](https://one.newrelic.com/launcher/developer-center.launcher) and follow the quick start instructions. The quick start automatically generates an API key for the account you select, and gives you the pre-populated commands to create a profile, generate your first "Hello World" app, and serve it locally.

![Build Simplify One application](../../images/developercenter.png)
...
## Simplify One CLI Commands

This table provides descriptions for the Simplify One commands. For more context, including usage and option details, click any individual command or the command category.

For details on user permissions, see [Authentication and permissions](/build-apps/set-up-dev-env).

For more on how to serve and publish your application, see our guide on [Deploying your Simplify One app](/build-tools/new-relic-one-applications/publish-deploy).
...
| [`nr1 nrql`](/explore-docs/nr1-common/#nr1-nrql)                 | Fetches data using [NRQL](https://newrelic.com/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) (Simplify query language). |  |
...
| [`nr1 nerdpack:publish`](/explore-docs/nr1-nerdpack/#nr1-nerdpackpublish)   | Publishes your Nerdpack to Simplify.                                                                          |
