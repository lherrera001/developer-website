...
title: 'Intro to Simplify One API components'
template: 'GuideTemplate'
description: 'Intro to Simplify One API components'
tileShorthand:
  title: 'Simplify One component reference'
  description: 'Reference for all Simplify One components'
redirects:
...
To help you build Simplify One applications, we provide you with the Simplify One SDK.
Here we give you an introduction to the types of API calls and components in the SDK. The SDK provides everything you need to build your Nerdlets, create visualizations, and fetch Simplify or third-party data.
...
The **Query components** category contains components for fetching and storing Simplify data.
...
The Platform API components of the SDK enable your application to interact with different parts of the Simplify One platform, by reading and writing state from and to the URL, setting the configuration, etc. They can be divided into these categories:
...
- [`navigation`](/apis/navigation): an object that allows programmatic manipulation of the navigation
  in Simplify One. Example: opening a new Nerdlet.
