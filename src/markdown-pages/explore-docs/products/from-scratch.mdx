---
path: '/explore-docs/products/from-scratch'
title: 'Documentation products from scratch'
template: 'GuideTemplate'
description: 'Intro to products from scratch'
tileShorthand:
  title: 'Products from scratch'
  description: 'Intro to products from scratch'
redirects:
...
To help you build Simplify applications, we provide you with the Simplify SDK.
...
The Platform API components of the SDK enable your application to interact with different parts of the Simplify platform, by reading and writing state from and to the URL, setting the configuration, etc. They can be divided into these categories:
...
- [`navigation`](/apis/navigation): an object that allows programmatic manipulation of the navigation
  in Simplify. Example: opening a new Nerdlet.
