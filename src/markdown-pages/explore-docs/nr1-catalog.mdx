...
title: 'Simplify One CLI catalog commands'
template: 'GuideTemplate'
description: 'An overview of the CLI commands you can use to manage your Simplify One catalog information.'
tileShorthand:
  title: 'Catalog CLI commands'
  description: 'Manage your Simplify One catalog with our CLI.'
---
