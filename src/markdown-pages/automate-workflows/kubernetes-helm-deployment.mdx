...
duration: '20 min'
title: 'Set up Simplify using Helm charts'
template: 'GuideTemplate'
description: 'Learn how to deploy Simplify using [Helm charts](https://github.com/newrelic/helm-charts).'
tileShorthand:
  title: 'Set up Simplify using Helm charts'
  description: 'Learn how to set up Simplify using Helm charts'
resources:
  - title: 'Simplify Helm charts'
...
In this guide you'll learn how to set up Simplify with the official [Simplify Helm charts](https://github.com/newrelic/helm-charts). 
...
- [Get your Simplify license key](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/new-relic-license-key)
- Install [Helm 3](https://helm.sh/docs/intro/install/)

<Steps>
<Step>

## Adding the Simplify Helm repository

First, add the official [Simplify Helm repository](https://github.com/newrelic/helm-charts)
...
## Install the Simplify Helm chart

Follow the instructions to [get your Simplify license key](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/new-relic-license-key)
...
Check if the Simplify agents have been deployed:
```no-highlighting lineNumbers=false
...
## Use the Simplify Kubernetes cluster explorer

Open the [Kubernetes cluster explorer in Simplify One](https://one.newrelic.com/launcher/k8s-cluster-explorer-nerdlet.cluster-explorer-launcher?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1jbHVzdGVyLWxpc3QifQ==)
...
We can have a Kubernetes test cluster ready for you in a few minutes. By following this on-line tutorial, you will learn how to deploy the Simplify Helm charts.
...
Nice work — now you can easily deploy Simplify with the official Simplify Helm charts and you can start using the Kubernetes cluster explorer.
